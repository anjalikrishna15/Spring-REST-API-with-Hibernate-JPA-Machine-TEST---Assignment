...
public class AdminController {
	...
	public List<BankDetails> getCustomer(@RequestHeader(value = "authorization", defaultValue = "") String auth)
	...
	public BankDetails getCustomerByAccNum(@PathVariable int accountNum,
	...
	public ResponseEntity<APIResponse> updateCustomer(@PathVariable int accNum, @PathVariable long mobNum,
			@PathVariable String email, @RequestHeader(value = "authorization", defaultValue = "") String auth)
			throws AccessDeniedException {
		jwtUtil.verifyAdmin(auth);
